...
//QW// FIXME: this looks broken. Unused aim vector.
// Shouldn't we be using the vector after setting it? P_ProjectSource?
...
void init_drone_infantry (edict_t *self)
{
	...
	self->health = 100 + 40*self->monsterinfo.level;
